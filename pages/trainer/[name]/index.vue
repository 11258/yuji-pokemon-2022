...
<template>
  <div>
    ...
    <GamifyDialog v-if="deleteDialog" id="confirm-delete" title="かくにん"
      description="ほんとうに　マサラタウンに　かえるんだな！　この　そうさは　とりけせないぞ！" @close="onCloseDelete">
    ...
    <GamifyDialog v-if="nicknameDialog" id="confirm-nickname" title="ニックネーム"
      ...
      <div class="item">
        ...
        <input id="name" @keydown.enter="onNickname(nicknameDialog)" v-model="nickname" />
      </div>
      <GamifyList :border="false" direction="horizon">
        <GamifyItem>
